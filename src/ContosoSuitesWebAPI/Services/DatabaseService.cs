...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get booking missing hotel rooms.")]
    ...
    [KernelFunction]
    [Description("Get booking with multiple rooms")]
